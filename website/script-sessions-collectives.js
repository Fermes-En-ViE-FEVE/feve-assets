...
function getEventsInTable(audience) {
	...
	.then(response => {
		...
		html += ("<div class'text-center'><div class='no_date_suits'>Aucune date ne me convient</div> <div class='date_session' onclick='updateChosenDateInForm(this)' id='aucune_date'>Tenez-moi au courant des prochaines sessions</div></div>");	
