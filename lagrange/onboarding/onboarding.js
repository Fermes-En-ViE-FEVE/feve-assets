MemberStack.onReady.then(member => {
    if (
        document.querySelector('#modal-onboarding') && member.loggedIn && !['', '/', '/redirect'].includes(window.location.pathname) && (!member.onboardingModal || window.location.href.includes('presentation=true'))
    ) {
